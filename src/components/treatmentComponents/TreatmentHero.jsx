...
const TreatmentHero = () => {
  return (
    ...
    <h1 className="TreatmentHeroTitle font-bold">Erectile Dysfunction?</h1>
    <p className='px-4 px-md-0 text-center text-md-start TreatmentHeroParagraph pt-2 pb-2'>ED is defined as the inability to sustain an erection sufficient for sexual intercourse. The condition can affect anyone at any age.</p>
