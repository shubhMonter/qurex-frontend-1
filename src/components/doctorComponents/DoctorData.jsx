    ...
    <div className="container">
      <div className="row">
        <div className="col-12">
          <div className="pb-12">
            Dr. {drDetailData?.userId?.name} is a well known men & women's
            sexual health expert. She has obtained his MBBS and DGO degrees from
            Netaji Subhash Chandra bose Medical College. <br />
            {!isOpened && (
              <a className="linkTag" onClick={() => showHideDetails()}>
                Show More
              </a>
            )}
          </div>
